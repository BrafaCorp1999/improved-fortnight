...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new dev.fluttercommunity.firebase_app_distribution.FirebaseAppDistributionPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin firebase_app_distribution_android, dev.fluttercommunity.firebase_app_distribution.FirebaseAppDistributionPlugin", e);
    }
    try {
